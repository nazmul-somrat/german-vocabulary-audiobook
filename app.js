...
async function loadCourseData(id){
  ...
  loading[id]=new Promise((resolve,reject)=>{
    ...
    s.src=meta.dataScript+(meta.dataScript.includes('?')?'&':'?')+'v=20260914-langfix1';
    s.onload=()=>{
